...
export class MyCarousel extends React.Component {
    ...
    _renderItem({item,index}){
        return (
          <View style={{
            ...
            <Image source={{uri:item.mainImage}} style={{width:"100%",height:"100%",resizeMode:'cover',borderRadius: 16,backgroundColor:"clear"}}/>
          </View>
    ...
    render() {
        return (
          <SafeAreaView style={{ backgroundColor:'clear', justifyContent:'center',alignItems:'center', alignContent:'center',flex:1 }}>
